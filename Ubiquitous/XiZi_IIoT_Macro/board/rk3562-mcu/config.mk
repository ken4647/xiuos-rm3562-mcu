...
export CFLAGS := -mcpu=cortex-m0 -mthumb  -ffunction-sections -fdata-sections -Dgcc -O0 -gdwarf-2 -g -fgnu89-inline -Wa,-mimplicit-it=thumb -Werror
...
export LFLAGS := -mcpu=cortex-m0 -mthumb  -ffunction-sections -fdata-sections -Wl,--gc-sections,-Map=XiZi.map,-cref,-u,rk3562_entry -T $(BSP_ROOT)/link.lds
export CXXFLAGS := -mcpu=cortex-m0 -mthumb  -ffunction-sections -fdata-sections -Dgcc -O0 -gdwarf-2 -g -Werror
...
export DEFINES := -DHAVE_CCONFIG_H  -DSOC_RK3562 -DHAL_MCU_CORE -DHAL_BUS_MCU_CORE -DHAVE_SIGINFO
