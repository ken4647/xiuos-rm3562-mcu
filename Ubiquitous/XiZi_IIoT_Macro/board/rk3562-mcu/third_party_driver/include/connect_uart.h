...
#define KERNEL_CONSOLE_BUS_NAME        SERIAL_BUS_NAME_9
#define KERNEL_CONSOLE_DRV_NAME        SERIAL_DRV_NAME_9
#define KERNEL_CONSOLE_DEVICE_NAME SERIAL_9_DEVICE_NAME_0
